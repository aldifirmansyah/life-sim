...
- `game/`: `items` (catalogue, gift preferences, shop stock, recipes), `stats` (energy, mood, money, skills, bag, jogging), `interact` (E targets: residents and things), `garden` (Raka's planters).
